...
<template>
  <div class="grid w-full grid-rows-2 gap-5 md:grid-cols-2 md:grid-rows-1">
    ...
    <div
      class="relative row-start-2 mx-auto my-auto h-[350px] w-4/5 rounded-lg p-1 text-center shadow-lg shadow-slate-300 hover:shadow-slate-400 md:col-start-2 md:row-start-1"
    >
